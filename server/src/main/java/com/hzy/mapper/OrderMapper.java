...
public interface OrderMapper {
    ...
    List<Double> sumByMaps(List<Map<String, Object>> dataTimeList);

    List<Integer> countByMaps(List<Map<String, Object>> dataTimeList);

    void batchUpdate(List<Order> ordersList);
}
